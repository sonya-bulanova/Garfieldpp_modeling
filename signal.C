...
int main(int argc, char * argv[]) {
 ...
 const double rPenning = 0;
  ...
  cmp.AddWire(0.05, 0, 2 * rWire, vWire, "s"); //0.06 cm
  // Add the tube.
...
drift.EnableSignalCalculation();
  ...
  const unsigned int nTracks = 20000;

  std::ofstream file_shift;
  std::string file_shift_name = "out_rTrack_distance.txt";
  file_shift.open(file_shift_name, std::ios::out);
  ...
  std::string outname="out_sig1/Ar_70_co2_30_1750V_B0_1atm_0_1mm_bin2000_" + std::to_string(j)+".sig";
